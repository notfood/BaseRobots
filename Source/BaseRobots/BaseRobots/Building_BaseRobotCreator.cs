...
namespace BaseRobot
{
	public class Building_BaseRobotCreator : Building
	{
		...
		public static ArcBaseRobot CreateRobot (string pawnDefName, IntVec3 position, Map map, Faction faction)
		{
			...
			PawnGenerationRequest gen = new PawnGenerationRequest (named, faction, PawnGenerationContext.NonPlayer, -1, true, true, false, false, false, false, 0, false, false, true, false, false, false, false, null, null, 0, 0, 0, Gender.None, 0, null);
